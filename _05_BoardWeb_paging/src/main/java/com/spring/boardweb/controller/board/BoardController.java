...
public class BoardController {
	...
	public String getBoardList(HttpSession session, Model model, @RequestParam Map<String, String> paramMap, Criteria cri) {
		...
		int total = boardService.getBoardCnt(paramMap); //검색조건에 따라 총 개수 세어주는 쿼리
